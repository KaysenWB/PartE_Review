...
parser.add_argument('--data_root', default='/home/user/Documents/Yangkaisen/Data/AIS_processed_com.cpkl', type=str)
...
for pp in [16]:
    ...
    model_single = ['Glow']
    model_gen = ['VAE', 'CVAE','GAN','Glow', 'RealNVP']
    model_alba = ['MFlow_aff','MFlow_aff_conv','MFlow_aff_act', 'MFlow_aff_ins', 'MFlow_aff_conv_act', 'MFlow_aff_conv_ins']

    model = model_alba

    name =  args.save_dir
    Metric = np.zeros((len(model), 9)) # six methods and seven indicator
