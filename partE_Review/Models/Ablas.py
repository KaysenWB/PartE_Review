...
class MFlow_aff (nn.Module):
    def __init__(self, args):
        super(MFlow_aff, self).__init__()
...
class MFlow_aff_act (nn.Module):
    def __init__(self, args):
        super(MFlow_aff_act, self).__init__()
...
class MFlow_aff_conv (nn.Module):
    def __init__(self, args):
        super(MFlow_aff_conv, self).__init__()
...
class MFlow_aff_ins (nn.Module):
    def __init__(self, args):
        super(MFlow_aff_ins, self).__init__()
...
class MFlow_aff_conv_act (nn.Module):
    def __init__(self, args):
        super(MFlow_aff_conv_act, self).__init__()
        ...
        self.glow = Flow_aff_conv_act(args)
...
class MFlow_aff_conv_ins (nn.Module):
    def __init__(self, args):
        super(MFlow_aff_conv_ins, self).__init__()
        ...
        self.glow = Flow_aff_conv_ins(args)
